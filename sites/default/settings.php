 ...
 * @endcode
 */
$settings['hash_salt'] = 'z4JvJDzfeg7ww1rggqj4f1IToslaHU9rLrLnYAr_7YPIJRoA_78L3SK_JrDzxQ-S8S_XuznSRQ';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_furniture_store_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_furniture_store_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
